...
public class Search {
  ...
  public void runSearch() {
    ...
    try {
      ...
      if (searchResultList != null) {
        prepareList(searchResultList.iterator(), queryTerm);
      }
   ...
   */
  private void prepareList(Iterator<SearchResult> iteratorSearchResults, String query) {

    list = new ArrayList<YouTubeVideo>();
    ...
    while (iteratorSearchResults.hasNext()) {
      ...
      if (rId.getKind().equals("youtube#video")) {
        ...
        video.setThumb(thumbnail.getUrl());
        System.out.println("\n-------------------------------------------------------------\n");
  ...
  public static void main(String[] args) {
      ...
      List<YouTubeVideo> results = search.search("Hobbit");
      
      for(YouTubeVideo r : results) {
          System.out.println(r.getTitle());
          System.out.println(r.getThumb());
